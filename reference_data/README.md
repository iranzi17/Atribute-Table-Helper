...
3. Choose **Use stored reference workbook** in the UI, select the workbook + sheet, review the automatic schema preview, and merge into your GeoPackage as usual.
